...
window.closeReviewModal = function () { if (window.app) window.app.closeReviewModal(); };
window.closeEditReviewModal = function () { if (window.app) window.app.closeEditReviewModal(); };
